...
`filo_antipeek` is a utility resource for FiveM designed to enhance combat realism and fairness by preventing players from shooting when their weapon's muzzle is obstructed by an object, even if their third-person camera suggests a clear line of sight.
